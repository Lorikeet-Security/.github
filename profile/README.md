...
- **[PCTFS-MICROLABS](https://github.com/Lorikeet-Security/PCTFS-MICROLABS)**: A free, standalone web application for hands-on cybersecurity skills practice. No subscription required.
- **[PCTFS_Crypto_Scanner](https://github.com/Lorikeet-Security/PCTFS_Crypto_scanner)**: Analyze any local workspace or GitHub repository for cryptographic primitives, risky implementations, and secret handling.
- **[install-diy-local-lab](https://github.com/Lorikeet-Security/install-diy-local-lab)**: Deploy a local, scaled-down version of popular vulnerable lab environments without paying for a subscription.
- **[Grpc_TradingServer](https://github.com/Lorikeet-Security/Grpc_TradingServer)**: Realtime price change server built with Kafka. Originally powered the *Wall Street Hijack* CTF challenge.
- **[parrot-recon](https://github.com/Lorikeet-Security/parrot-recon)**: Recon automation tooling for bug bounty hunters.
- **[MobileApp-Pentest-Cheatsheet](https://github.com/Lorikeet-Security/MobileApp-Pentest-Cheatsheet)**: A concise, high-value reference for mobile application penetration testing topics.
- **[OWASP-Testing-Checklist](https://github.com/Lorikeet-Security/OWASP-Testing-Checklist)**: An Excel-based OWASP web application security testing checklist for tracking test case status.
- **[pentest-automation](https://github.com/Lorikeet-Security/pentest-automation)**: A growing collection of penetration testing automation scripts.
- **[Parrot_CTFs-Layan-gtk-theme](https://github.com/Lorikeet-Security/Parrot_CTFs-Layan-gtk-theme)**: Parrot CTFs-branded GTK theme for AthenaOS.
...
- **Sponsor**: Support our open-source work via [GitHub Sponsors](https://github.com/sponsors/Lorikeet-Security).
